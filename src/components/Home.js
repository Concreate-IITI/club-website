    ...
    <div className="min-h-screen relative">
          ...
          <div className="relative z-10 py-12">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-semibold text-white mb-6">
                Civil Engineering Student Club - IIT Indore
              </h2>
              <p className="text-lg md:text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed">
                Driving hands-on learning, innovation, and collaboration. Through workshops, student-led projects, 
                competitions, and the flagship CivilX Series, we bridge classroom knowledge with real-world 
                engineering challenges—preparing future engineers to shape sustainable and resilient infrastructures.
              </p>
            </motion.div>
            ...
            >
              <Link href="/team">
                <motion.button 
                  className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-full hover:shadow-lg hover:shadow-cyan-400/25 transition-all duration-300"
              ...
              <Link href="/message-us">
                <motion.button 
                  className="px-8 py-4 border-2 border-cyan-400/80 text-cyan-400 font-semibold rounded-full hover:bg-cyan-400/10 backdrop-blur-sm transition-all duration-300"
                  whileHover={{ scale: 1.05, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Get In Touch
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="group"
              >
                <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 hover:border-cyan-400/50 transition-all duration-300 hover:transform hover:scale-105 hover:bg-white/15">
      ...
      >
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-12 hover:border-cyan-400/50 transition-all duration-500">
            <motion.h3 
            ...
            >
              Join our community of innovative civil engineers and be part of groundbreaking projects 
              that build tomorrow's sustainable infrastructure. From concept to construction, we're building the future together.
            </motion.p>
            <motion.div 
            ...
            >
              ...
              <Link href="/recentActivities">
                <motion.button 
                  className="px-8 py-4 border-2 border-cyan-400/50 text-cyan-400 font-semibold rounded-full hover:bg-cyan-400/10 transition-all duration-300"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Recent Activities
