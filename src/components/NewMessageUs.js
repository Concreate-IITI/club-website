  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Build error message with specific validation errors if available
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              <div className="space-y-6">
                ...
                >
                  Whether you're a fellow civil engineering enthusiast, industry professional,
                  potential collaborator, or simply curious about our innovative projects, we're
                  always excited to connect with passionate individuals who share our vision for the
              ...
              <div className="bg-gradient-to-br from-slate-900/90 via-slate-800/90 to-slate-900/90 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 hover:border-sky-400/50 transition-all duration-500">
                ...
                {submitStatus.message && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className={`mb-6 p-4 rounded-xl border ${submitStatus.type === 'success' ? 'bg-green-500/20 border-green-500/50 text-green-300' : 'bg-red-500/20 border-red-500/50 text-red-300'}`}
                  >
      ...
      >
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="bg-gradient-to-br from-slate-900/90 via-slate-800/90 to-slate-900/90 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-12 hover:border-cyan-400/50 transition-all duration-500">
            ...
            >
              Become part of a vibrant community of innovators, creators, and future leaders in
              civil engineering. Together, we're building tomorrow's infrastructure today.
            </motion.p>
            <motion.div
