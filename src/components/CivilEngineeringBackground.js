  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <pattern id="structural-pattern" width="120" height="120" patternUnits="userSpaceOnUse">
              <circle cx="60" cy="60" r="3" fill="purple" opacity="0.4" />
              <path d="M 0 60 L 120 60 M 60 0 L 60 120" stroke="purple" strokeWidth="0.8" opacity="0.3" />
              <path d="M 30 30 L 90 30 L 90 90 L 30 90 Z" fill="none" stroke="purple" strokeWidth="0.6" opacity="0.4" />
              <path d="M 45 45 L 75 45 L 75 75 L 45 75 Z" fill="none" stroke="pink" strokeWidth="0.4" opacity="0.3" />
            </pattern>
          </defs>
      ...
      <div className="absolute inset-0">
        ...
        {/* Second Building */}
        <motion.div
          className="absolute top-32 right-16 w-36 h-44 border-2 border-purple-400/40 shadow-md shadow-purple-400/10"
          animate={{
            y: [0, -15, 0],
        ...
        >
          <div className="w-full h-1/4 border-b border-purple-400/30"></div>
          <div className="w-full h-1/4 border-b border-purple-400/30"></div>
          <div className="w-full h-1/4 border-b border-purple-400/30"></div>
          <div className="absolute top-2 left-2 w-4 h-4 border border-purple-400/40 bg-purple-400/5"></div>
          <div className="absolute top-2 right-2 w-4 h-4 border border-purple-400/40 bg-purple-400/5"></div>
        </motion.div>
        ...
        >
          <div className="w-full h-2 bg-gradient-to-r from-purple-400/30 to-cyan-400/30 mb-2 shadow-md shadow-purple-400/10"></div>
          <div className="flex justify-between">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="w-1 h-16 bg-purple-400/25"></div>
            ))}
          </div>
          <div className="w-full h-2 bg-gradient-to-r from-purple-400/30 to-cyan-400/30 shadow-md shadow-cyan-400/10"></div>
          {/* Bridge supports */}
          <div className="absolute -bottom-4 left-8 w-2 h-8 bg-purple-400/20"></div>
          <div className="absolute -bottom-4 right-8 w-2 h-8 bg-purple-400/20"></div>
        </motion.div>
        ...
        >
          <div className="absolute top-0 left-0 w-full h-3 bg-gradient-to-r from-cyan-400/25 to-purple-400/25 transform rotate-12 shadow-md shadow-cyan-400/10"></div>
          <div className="absolute top-12 left-0 w-full h-3 bg-gradient-to-r from-purple-400/25 to-pink-400/25 transform -rotate-12 shadow-md shadow-purple-400/10"></div>
          <div className="absolute top-24 left-0 w-full h-3 bg-gradient-to-r from-pink-400/25 to-cyan-400/25 transform rotate-6 shadow-md shadow-pink-400/10"></div>
          {/* Connection points */}
          <div className="absolute top-6 left-16 w-3 h-3 bg-cyan-400/40 rounded-full"></div>
          <div className="absolute top-18 right-16 w-3 h-3 bg-purple-400/40 rounded-full"></div>
        </motion.div>
        ...
        <div className="absolute inset-0">
          {[...Array(12)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-20 h-20 border-2 border-purple-400/25 shadow-md shadow-purple-400/5"
              style={{
                top: `${15 + i * 8}%`,
                left: `${8 + i * 7}%`,
            ...
            >
              <div className="absolute top-1/2 left-1/2 w-4 h-4 bg-purple-400/30 transform -translate-x-1/2 -translate-y-1/2 rounded-full"></div>
              <div className="absolute top-2 left-2 w-2 h-2 bg-purple-400/25 rounded-full"></div>
              <div className="absolute bottom-2 right-2 w-2 h-2 bg-purple-400/25 rounded-full"></div>
            </motion.div>
          ))}
        </div>
        ...
        <svg className="absolute inset-0 w-full h-full opacity-15" xmlns="http://www.w3.org/2000/svg">
          ...
          <motion.path d="M 50 200 L 150 150 L 250 200 L 350 150 L 450 200" fill="none" stroke="purple" strokeWidth="2" strokeDasharray="6,6" animate={{ strokeDashoffset: [0, -24] }} transition={{ duration: 4, repeat: Infinity, ease: "linear" }} />
          <motion.path d="M 0 300 Q 100 250 200 300 Q 300 350 400 300 Q 500 250 600 300" fill="none" stroke="pink" strokeWidth="1.5" strokeDasharray="4,8" animate={{ strokeDashoffset: [0, -36] }} transition={{ duration: 5, repeat: Infinity, ease: "linear" }} />
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-400/8 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-pink-400/8 rounded-full blur-3xl animate-pulse delay-2000" />
        ...
        <div className="absolute bottom-32 left-16 w-40 h-40 bg-purple-400/10 rounded-full blur-2xl animate-pulse delay-1500" />
      </div>
    </div>
  )
}
